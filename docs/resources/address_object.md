...
* `address_group_ids` - (Required) List of Standalone Address Objects to be included in the membership
* `excluded_address_group_ids` - (Optional) List of Standalone Address Objects to be excluded in the membership
